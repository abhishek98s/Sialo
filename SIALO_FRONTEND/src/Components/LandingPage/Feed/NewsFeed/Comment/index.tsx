                ...
                <section className={`${styles.storys} + mx-[5px]`}>
                    <div className={`${styles.story} + w-[34px] bg-slate-200 h-[34px] rounded-full grid place-items-center`}>
                        <div className={`w-[30px] h-[30px] rounded-full overflow-hidden`}>
                            <Image src={comment.userImg || comment.comment_user_picture} alt="sialo.vercel.app" width={100} height={100} />
                        </div>
                    </div>
                </section>

                <h4 className={`body_Medium_Bold w-[max-content]`}>{`${comment.firstName || comment.comment_user_name}:`}
